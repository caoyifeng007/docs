[Netty 核心原理剖析与 RPC 实践](https://kaiwu.lagou.com/course/courseInfo.htm?courseId=516&sid=20-h5Url-0&buyFrom=2&pageId=1pz4#/detail/pc?id=4925)
...
> ### 背景知识
>
> jemalloc 是由 Jason Evans 在 FreeBSD 项目中引入的新一代内存分配器。它是一个通用的 malloc 实现，侧重于减少内存碎片和提升高并发场景下内存的分配效率，其目标是能够替代 malloc。jemalloc 应用十分广泛，在 Firefox、Redis、Rust、Netty 等出名的产品或者编程语言中都有大量使用。具体细节可以参考 Jason Evans 发表的论文 [[《A Scalable Concurrent malloc Implementation for FreeBSD》\]](https://kaiwu.lagou.com/course/(https://people.freebsd.org/~jasone/jemalloc/bsdcan2006/jemalloc.pdf))
>
...
>
> ![Drawing 0.png](https://s0.lgstatic.com/i/image/M00/71/6D/CgqCHl--HxSAH5EGAANWzZRA9Kg017.png)
>
...
>
> ![Drawing 1.png](https://s0.lgstatic.com/i/image/M00/71/62/Ciqc1F--HxyAbK3CAAQ1Tsz2fsY135.png)
>
...
>
> ![图片3.png](https://s0.lgstatic.com/i/image/M00/71/6C/Ciqc1F--Oq2AL3z_AALiP5oG4Kg709.png)
>
...
>
> ![图片4.png](https://s0.lgstatic.com/i/image/M00/71/6C/Ciqc1F--OrmAQbSMAALYfPT8Bo0517.png)
>
...
>
> ![图片5.png](https://s0.lgstatic.com/i/image/M00/71/6C/Ciqc1F--OsOAIwduAAKS6MtXII4882.png)
>
> #### 伙伴算法
>
